...
class Train:
    ...
    def train(self, train_corpus):
        ...
        for batch_no in range(1, num_batches + 1):
            ...
            q1_var, q1_len, q2_var, q2_len = helper.batch_to_tensor(train_batches[batch_no - 1], self.dictionary,
    ...
    def validate(self, dev_corpus):
        ...
        for batch_no in range(1, num_batches + 1):
            q1_var, q1_len, q2_var, q2_len = helper.batch_to_tensor(dev_batches[batch_no - 1], self.dictionary,
                                                                    reverse=self.config.reverse, iseval=True)
            if self.config.cuda:
                q1_var = q1_var.cuda()  # batch_size x max_len
                q2_var = q2_var.cuda()  # batch_size x max_len
                q2_len = q2_len.cuda()  # batch_size
