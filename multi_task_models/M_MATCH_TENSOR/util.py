...
def get_args():
    parser = ArgumentParser(description='Multi-task Match Tensor')
    ...
    parser.add_argument('--nhid_session', type=int, default=300,
                        help='number of hidden units per layer for session-level query encoder')
    ...
    parser.add_argument('--save_path', type=str, default='../mmt_output/',
